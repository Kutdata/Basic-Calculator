# -*- coding: utf-8 -*-
"""
Created on Thu Dec 12 09:18:34 2024
...
class Calculator:
    def __init__(self,master):
        ...
        self.entry_value = ''
        Entry(width=17, bg='#EED5B7',font=('Arial Bold',28), textvariable=self.equation).place(x=0,y=0)
        ...
        Button(width=11, height=4, text='=', relief='flat', bg='cornsilk3', command = self.solve).place(x=270,y=350)                                                                                                       
